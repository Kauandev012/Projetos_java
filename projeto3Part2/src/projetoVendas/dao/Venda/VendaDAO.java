...
import projetoVendas.dao.generic.GenericDAO;
import projetoVendas.domain.Produto;
import projetoVendas.domain.ProdutoQuantidade;
...
import projetoVendas.factory.ProdutoQuantidadeFactory;
import projetoVendas.factory.VendaFactory;
...
//		return venda;
    ...
    private void buscarAssociacaoVendaProdutos(Connection connection, Venda venda)
        ...
        try {
            ...
            while(rsProd.next()) {
                Produto prodQ = ProdutoQuantidadeFactory.convert(rsProd);
                produtos.add(prodQ);
            }
    ...
    private StringBuilder sqlBaseSelect() {
        ...
        sb.append("C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C.ESTADO, C.SOBRE_NOME ");
