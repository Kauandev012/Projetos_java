...
import projetoVendas.annotation.*;
...
public class Venda  implements Persistente {
    ...
    public void adicionarProduto(Produto produto, Integer quantidade) {
        ...
        Optional<ProdutoQuantidade> op =
                produtos.stream()
                        .filter(filter -> filter.getProduto() != null && filter.getProduto().getCodigo().equals(produto.getCodigo())).findAny();
        if (op.isPresent()) {
