...
import projetoVendas.dao.ClienteDAO;
import projetoVendas.dao.IClienteDAO;
import projetoVendas.dao.IProdutoDAO;
import projetoVendas.dao.ProdutoDAO;
import projetoVendas.dao.IVendaDAO;
import projetoVendas.dao.VendaDAO;
import projetoVendas.dao.jdbc.ConnectionFactory;
import projetoVendas.domain.Cliente;
import projetoVendas.domain.Produto;
import projetoVendas.domain.Venda;
import projetoVendas.domain.Venda.Status;
...
public class VendaDAOTest {
    ...
    private Cliente cadastrarCliente() throws TipoChaveNaoEncontradaException, DAOException {
        ...
        cliente.setTel(119999239L);
        cliente.setSobreNome("jonas");
